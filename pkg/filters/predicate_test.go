...
func Test_IncludeTestPredict(t *testing.T) {
	ab := &models.SubCategory{AuditTests: []*models.CheckSpec{{Name: "1.2.1 abc"}, {Name: "1.2.3 eft"}}}
...
func Test_NodePredicateMaster(t *testing.T) {
	ab := &models.SubCategory{AuditTests: []*models.CheckSpec{{Name: "1.2.1 abc", ProfileApplicability: "Master"}, {Name: "1.2.3 eft", ProfileApplicability: "Worker"}}}
