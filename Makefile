...
test_rego:
	...
	./opa test ./internal/security/mesh/istio/proxy_blocks_external_host_within_mesh_test.rego ./internal/security/mesh/istio/proxy_blocks_external_host_within_mesh.rego -v
